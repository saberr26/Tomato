    ...
    BasicAlertDialog(onDismissRequest = onDismiss) {
        Surface(
            ...
            Column(
                ...
                Text("Icon Customization", style = MaterialTheme.typography.titleLarge)
                Spacer(Modifier.height(16.dp))

                DynamicIcon(settingsState = settingsState, modifier = Modifier.size(64.dp).align(Alignment.CenterHorizontally))
                ...
                if (!settingsState.iconUseDynamic) {
                    ...
                    Text("Hue")
                    Slider(
                        value = settingsState.iconColor.toColor().let { /* Simplified Hue extraction */ 0f },
